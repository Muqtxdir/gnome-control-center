...
struct _CcMultitaskingPanel
{
  ...
  GtkListBox      *multimonitor_listbox;
  GtkListBox      *application_switching_listbox;
...
cc_multitasking_panel_class_init (CcMultitaskingPanelClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, CcMultitaskingPanel, general_listbox);
  gtk_widget_class_bind_template_child (widget_class, CcMultitaskingPanel, workspaces_listbox);
  gtk_widget_class_bind_template_child (widget_class, CcMultitaskingPanel, multimonitor_listbox);
  gtk_widget_class_bind_template_child (widget_class, CcMultitaskingPanel, application_switching_listbox);
...
cc_multitasking_panel_init (CcMultitaskingPanel *self)
{
  ...
  gtk_list_box_set_header_func (self->workspaces_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
                                
  gtk_list_box_set_header_func (self->multimonitor_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
  
  gtk_list_box_set_header_func (self->application_switching_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
