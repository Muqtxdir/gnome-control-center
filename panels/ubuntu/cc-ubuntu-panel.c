...
cc_ubuntu_panel_init (CcUbuntuPanel *self)
{
  ...
  gtk_list_box_set_header_func (self->dock_general_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);

  gtk_list_box_set_header_func (self->dock_behavior_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
                                
  gtk_list_box_set_header_func (self->dock_position_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
                                
  gtk_list_box_set_header_func (self->dock_launcher_listbox,
                                cc_list_box_update_header_func,
                                NULL, NULL);
